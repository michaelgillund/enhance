...
class RequestWebView: UIViewController, WKNavigationDelegate {

    //Variables
    var supremeBrowser: WKWebView?
    var supremeBot: SupremeUS?
    ...
    override func viewDidLoad() {
        ...
        //Initialize Bot
        self.supremeBot = SupremeUS(withViewController: self)
