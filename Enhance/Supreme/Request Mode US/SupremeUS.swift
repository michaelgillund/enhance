...
var fullNameReq = UserDefaults.standard.string(forKey: "customerSup") ?? ""
var emailReq = UserDefaults.standard.string(forKey: "emailSup") ?? ""
var phoneReq = UserDefaults.standard.string(forKey: "phoneSup") ?? ""
var addressReq = UserDefaults.standard.string(forKey: "addressSup") ?? ""
var address2Req = UserDefaults.standard.string(forKey: "address2Sup") ?? ""
var zipReq = UserDefaults.standard.string(forKey: "zipSup") ?? ""
var cityReq = UserDefaults.standard.string(forKey: "citySup") ?? ""
var stateReq = UserDefaults.standard.string(forKey: "stateSup") ?? ""
var countryReq = UserDefaults.standard.string(forKey: "countrySup") ?? ""

var ccReq = UserDefaults.standard.string(forKey: "ccSup") ?? ""
var monthReq = UserDefaults.standard.string(forKey: "monthSup") ?? ""
var yearReq = UserDefaults.standard.string(forKey: "yearSup") ?? ""
var cvvReq = UserDefaults.standard.string(forKey: "cvvSup") ?? ""

let locationReq = UserDefaults.standard.string(forKey: "locationReq") ?? ""
let delayReq = UserDefaults.standard.string(forKey: "delayReq") ?? ""
...
class SupremeUS
{
    ...
    let keyword1 = UserDefaults.standard.string(forKey: "keyword1Req") ?? ""
    let category1 = UserDefaults.standard.string(forKey: "category1Req") ?? ""
    let size1 = UserDefaults.standard.string(forKey: "size1Req") ?? ""
    let color1 = UserDefaults.standard.string(forKey: "color1Req") ?? ""
    ...
    let cardTypes = ["Visa", "American Express", "Mastercard", "Solo"]
    
    let first1 = String(ccReq.prefix(1))
    var cardType = ""
    ...
    lazy var ccType: String = { "\(self.cardTypes)" }() // "Visa", "American Express", "Mastercard", "Solo"
    
    
    //DO NOT EDIT BELOW THIS LINE
    
    //Class Variables
    weak var supremeInstance: SupremeUS?
    ...
    var requestWebView: RequestWebView?

    
    //Link viewController again
    init(withViewController viewController: RequestWebView)
    {
        self.requestWebView = viewController
    }
    
    //INIT SUPREMEINSTANCE
    init(withSupremeInstance supremeInstance: SupremeUS)
    {
    ...
    func pasteInfo()
    {
        ...
        {
            DispatchQueue.main.async{
                self.requestWebView?.supremeBrowser?.evaluateJavaScript("document.getElementById(\"\(String(self.idState))\").focus()", completionHandler: nil)
                
                self.requestWebView?.supremeBrowser?.evaluateJavaScript("document.getElementById('\(String(self.idState))\').value = \"\(String(self.uState))\"", completionHandler: nil)
                self.requestWebView?.supremeBrowser?.evaluateJavaScript("document.getElementById('\(String(self.idState))\').dispatchEvent(event)", completionHandler: nil)
