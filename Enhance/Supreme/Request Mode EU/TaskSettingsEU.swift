...
class TaskSettingsEU: UITableViewController, UITextFieldDelegate, SFSafariViewControllerDelegate{
    ...
    func safariBtn(){
        ...
        @objc func start(_ sender: Any) {
            defaults.set(keywords1.text!, forKey: "keyword1ReqEU")
            defaults.set(category1.text!, forKey: "category1ReqEU")
            defaults.set(size1.text!, forKey: "size1ReqEU")
            defaults.set(color1.text!, forKey: "color1ReqEU")

            if keywords1.text != "" && size1.text != "" && category1.text != "" && color1.text != ""{
                self.performSegue(withIdentifier: "startReqEU", sender: self)
            }
        ...
        func setupArrays() {
            ...
            locations = ["","US","EU"]
            savedTasks = defaults.stringArray(forKey: "savedReqEU") ?? [""]
        }
        ...
        func createPickerView() {
            ...
            let doneButton = UIBarButtonItem(title: "Done", style: .plain, target: self, action: #selector(TaskSettings.dismissKeyboard))
...
//            locationLbl.inputAccessoryView = toolBar
    ...
    extension TaskSettingsEU: UIPickerViewDelegate, UIPickerViewDataSource {
