...
class MultiProfileCell: UICollectionViewCell{
    ...
    func setup() {
        ...
        contentView.backgroundColor = UIColor(red: 0.00, green: 0.38, blue: 0.97, alpha: 1.00)
        ...
        NSLayoutConstraint.activate([
            ...
            cardLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 10),
            cardLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -10),
